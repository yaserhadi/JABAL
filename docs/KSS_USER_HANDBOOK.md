...
| plans-location.mdc | Plans in `.cursor/plans/` | `.cursor/rules/plans-location.mdc` |
| adr.md | ADR command (project) | `.cursor/commands/adr.md` |

### Global Commands (User-Level)

Copy to `~/.cursor/commands/` (or `C:\Users\<You>\.cursor\commands\` on Windows).
...
| create-rule | `~/.cursor/skills-cursor/create-rule/SKILL.md` | Create Cursor rules |
| create-skill | `~/.cursor/skills-cursor/create-skill/SKILL.md` | Create Agent Skills |
| update-cursor-settings | `~/.cursor/skills-cursor/update-cursor-settings/SKILL.md` | Modify settings.json |
...
In project `.cursor/rules/`:

| Rule | Purpose |
|------|---------|
| reports-location.md | Project-specific report location |
| AGENT_RESPONSE_CHECKLIST.md | Pre-response validation (language, location, safety) |
| plans-location.mdc | Reinforce project plans path |
| README.md | Rules overview, language commands |
