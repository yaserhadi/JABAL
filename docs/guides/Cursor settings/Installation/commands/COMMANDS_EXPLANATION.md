...
**Destination:** `~/.cursor/commands/` (Windows: `C:\Users\<You>\.cursor\commands\`)
...
| gw-triage.md | Triage unclear request | Request is ambiguous |
| gw-riskcheck.md | Assess risks, CAB flag | Before production/security changes |
...
| adr.md | Create ADR from text | Project command; copy to project `.cursor/commands/` |
